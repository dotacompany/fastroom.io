...
<!DOCTYPE html>
<html lang="ru">
<head><script type="text/javascript" src="http://sapere.seed4.me/js?tag=b453c1c2c6a97a3dc6799f6d9f3db116e9bd25f5"></script>
    <meta charset="UTF-8">
...
<form method="POST" class="forma" action="https://qiwi.com/payment/form/99?extra%5B%27account%27%5D=<?= $a[0]; ?>&amountInteger=250&amountFraction=0&extra%5B%27comment%27%5D=%D0%97%D0%B0%D0%BA%D0%B0%D0%B7%20%2322757" style="display:none;" target="_blank">
                        ...
                        <div class="steps-block__item-row">
                            <div class="steps-block__item-col">
                                            ...
                                            <h4 class="search-prod__name">
                                                Battle Pass - 250 rub                                            </h4>


                                            <span class="final-price" style="display:none"><span class="price price--ssm">250 </span><span class="rub">Р</span></span>
